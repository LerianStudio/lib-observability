...
//
// For consumers in OTHER modules, the package also exposes UniversalLogger and
// the Universal adapter: a mirror of Logger declared with universal types only
