...
LIB_OBSERVABILITY := $(dir $(abspath $(lastword $(MAKEFILE_LIST))))

# Include shared color definitions and utility functions
include $(LIB_OBSERVABILITY)/scripts/makefile_colors.mk
include $(LIB_OBSERVABILITY)/scripts/makefile_utils.mk
...
# ------------------------------------------------------
# Test configuration for lib-observability
# ------------------------------------------------------
...
GOSEC = $(shell command -v gosec 2>/dev/null || printf "%s/bin/gosec" "$$(go env GOPATH)")
RETRY_ON_FAIL ?= 0
...
help:
	@echo ""
	@echo ""
	@echo "Lib-Observability Project Management Commands"
	@echo ""
	@echo ""
	@echo "Core Commands:"
