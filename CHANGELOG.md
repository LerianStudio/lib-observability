...
- Add opt-in `lerian.http.server.responses_4xx.by_tenant` counter for authenticated
  tenant and normalized route, without exact status-code cardinality. (@gauchito91)
