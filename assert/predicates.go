...
// Transaction status constants used by the predicates.
// These mirror the domain constants from lib-commons and are kept here to avoid
// importing non-observability packages.
const (
	txnCreated  = "CREATED"
	txnApproved = "APPROVED"
	txnPending  = "PENDING"
	txnCanceled = "CANCELED"
	txnNoted    = "NOTED"
)
