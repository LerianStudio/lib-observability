...
// route/status attribution (measured). Recovering here and falling back to a
// plain 500 keeps the normal finalization path running regardless, so
// telemetry above still sees a complete picture.
