...
| `lerian.http.server.requests.by_tenant` | Counter | {request} | tenant.id autenticado, tenant.slug opcional, http.route | OPT-IN |
| `lerian.http.server.responses_4xx.by_tenant` | Counter | {request} | tenant.id autenticado, tenant.slug opcional, http.route | OPT-IN; somente HTTP 4xx; sem status exato |
| `lerian.http.server.responses_5xx.by_tenant` | Counter | {request} | tenant.id autenticado, tenant.slug opcional, http.route | OPT-IN; somente HTTP 5xx; sem status exato |
| `lerian.http.server.latency.by_tenant` | Histogram | s | tenant.id autenticado, tenant.slug opcional, http.response.status_class (1xx–5xx, other) | OPT-IN |
